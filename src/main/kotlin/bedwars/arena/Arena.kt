...
import bedwars.obj.BedWarsData
...
import bedwars.task.WorldCopyTask
import bedwars.utils.*
...
class Arena(var id: String, var plugin: BedWars) : Listener {
    ...
    private val mainData: Map<String, Vector3> = Collections.unmodifiableMap(this.plugin.arenas[this.id])
